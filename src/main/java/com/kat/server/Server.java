...
public class Server extends AbstractServerComponent{
    ...
    public int getPort() throws IOException {
        ServerSocketChannel serverChannel = (ServerSocketChannel) abstractSelectableChannel;
    ...
    protected Selector selector() throws IOException {
        ...
        abstractSelectableChannel.register(selector, OP_ACCEPT);
        return selector;
    }
